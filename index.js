...
let dcacheApiConf = [
    ...
    ['post', '/cache/addConfig', addConfig, {item: 'notEmpty', path: 'notEmpty', period: 'notEmpty', reload: 'notEmpty', remark: 'notEmpty'}],
    ['get', '/cache/deleteConfig', deleteConfig, {id: 'notEmpty'}],
    ['post', '/cache/editConfig', editConfig, {id: 'notEmpty', item: 'notEmpty', path: 'notEmpty', period: 'notEmpty', reload: 'notEmpty', remark: 'notEmpty'}],
    ['get', '/cache/getModuleConfig', getModuleConfig, {moduleName: 'notEmpty'}],
    ['get', '/cache/getServerConfig', getServerConfig, {moduleName: 'notEmpty', serverName: 'notEmpty', nodeName: 'notEmpty',}],
